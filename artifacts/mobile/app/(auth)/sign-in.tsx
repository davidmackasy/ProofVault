      ...
      >
        ...
        <View style={styles.form}>
          ...
          >
            ...
            <Text style={[styles.appleBtnText, { color: colors.text }]}>Sign in with Apple</Text>
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  forgot: { fontFamily: "Inter_500Medium", fontSize: 13 },
  ...
  signupLabel: { fontFamily: "Inter_400Regular", fontSize: 14 },
